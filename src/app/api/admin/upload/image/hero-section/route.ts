// api/admin/upload/image/hero-section/route.ts
...
export async function POST(request: NextRequest) {
    try {
        ...
        const uploadDir = path.join(process.cwd(), 'public', 'uploads', 'images', 'hero_section');
        try {
        ...
        // Return the URL
        const fileUrl = `/uploads/images/hero_section/${filename}`;
